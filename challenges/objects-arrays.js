...
console.log(`Diet of a velociraptor is ${velociraptor.diet}.`);

// How long was a stegosaurus?
console.log(`Stegosaurus was lived in the ${stegosaurus.period}`);

// What time period did tyrannosaurus live in?
console.log(`Tyrannosaurus was lived in the ${tyrannosaurus.period}`);
...
that contains both first name and email of each student. This will be an array of strings.
...
const unisWithUni = graduates.filter(({ university }) =>
  university.includes("Uni")
);
...
*/
const displayNames = zooAnimals.map(
  ({ animal_name: an, scientific_name: sn }) => `Name: ${an}, Scientific: ${sn}`
);
...
*/
const lowPopulationAnimals = zooAnimals.filter(({ population: p }) => p < 5);
